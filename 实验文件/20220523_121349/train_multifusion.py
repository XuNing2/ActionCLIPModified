...
def main():
    ...
    early_fusion4 = Early_fusion(num_segments=4)
    ...
    for epoch in range(start_epoch, config.solver.epochs):
        ...
        for kkk,(images,list_id) in enumerate(tqdm(train_loader)):
            ...
            input1, input2 = torch.split(images, t // 2, dim=1)
            ...
            image_embedding = torch.stack((image_embedding1, image_embedding2), dim=2)
